...
string GetKarakteristike(Karakteristike k) {
	switch (k)
	{
...
public:
	...
	Rjecnik<T1, T2> operator()(int start, int end) {
		Rjecnik<T1, T2> temp;
...
public:
	...
	void DodajKupovinu(float cijena, ZadovoljstvoKupca z) {

		_kupovine->AddElement(cijena, z);
